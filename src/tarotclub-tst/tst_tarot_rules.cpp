...
void TarotRules::TestScoreCalculation()
{
    ...
    bool actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/tarotmag_17.json");
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/taker_loses_two_oudlers.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/tarotmag_18.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/01-T_lasttrickbydefense_game_lost.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/01-T_lasttrickbydefense_game_won.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/3_oudlers.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/4_oudlers_bug.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/maximum_points.json");
    QCOMPARE(actual_bool, true);
    ...
    actual_bool = deal.LoadGameDealLog(Util::GetCurrentDirectory() + "/played_deals/slam_announced_failure.json");
    QCOMPARE(actual_bool, true);

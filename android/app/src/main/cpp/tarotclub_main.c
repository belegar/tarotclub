...
Java_fr_tarotclub_TarotClub_MainActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "fr/tarotclub/TarotClub/JniHandler");
...
Java_fr_tarotclub_TarotClub_MainActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_fr_tarotclub_TarotClub_MainActivity_StopTicks(JNIEnv *env, jobject instance) {
